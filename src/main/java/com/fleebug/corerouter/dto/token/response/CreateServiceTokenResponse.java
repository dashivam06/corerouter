...
@NoArgsConstructor
@AllArgsConstructor
@Schema(title = "Create Service Token Response", description = "Response containing token metadata plus raw token returned once")
public class CreateServiceTokenResponse {
    ...
    @Schema(description = "Raw token value returned once at creation time", example = "svc_a1b2c3d4e5f6.XYZrandomstring")
